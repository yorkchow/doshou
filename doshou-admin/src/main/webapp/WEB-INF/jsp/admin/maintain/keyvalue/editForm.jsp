    ...
    <ul class="nav nav-tabs">
        ...
        <c:if test="${op eq '新增'}">
            <li ${op eq '新增' ? 'class="active"' : ''}>
                <a href="${ctx}/admin/maintain/keyvalue/create?backURL=<doshou:backURL/>">
        ...
        <c:if test="${not empty m.id}">
            <li ${op eq '查看' ? 'class="active"' : ''}>
                <a href="${ctx}/admin/maintain/keyvalue/${m.id}?backURL=<doshou:backURL/>">
            ...
            <li ${op eq '修改' ? 'class="active"' : ''}>
                <a href="${ctx}/admin/maintain/keyvalue/${m.id}/update?backURL=<doshou:backURL/>">
                    <i class="icon-edit"></i>
                    修改
                </a>
            </li>
            ...
            <li ${op eq '删除' ? 'class="active"' : ''}>
                <a href="${ctx}/admin/maintain/keyvalue/${m.id}/delete?backURL=<doshou:backURL/>">
