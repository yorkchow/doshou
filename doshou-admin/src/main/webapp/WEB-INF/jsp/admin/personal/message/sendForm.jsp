...
<div class="panel">
    ...
    <ul class="nav nav-tabs">
        <c:if test="${op eq '发送草稿'}">
            <li class="active">
                <a href="${ctx}/admin/personal/message/draft/${m.id}/send?BackURL=<doshou:backURL/>">
        ...
        <c:if test="${op eq '发送新消息'}">
            <li class="active">
                <a href="${ctx}/admin/personal/message/send?BackURL=<doshou:backURL/>">
                    <i class="icon-file-alt"></i>
                        ${op}
                </a>
            </li>
        ...
        <c:if test="${op eq '回复消息'}">
            <li class="active">
                <a href="${ctx}/admin/personal/message/${parent.id}/reply?BackURL=<doshou:backURL/>">
                    <i class="icon-file-alt"></i>
                        ${op}
                </a>
            </li>
        ...
        <c:if test="${op eq '转发消息'}">
            <li class="active">
                <a href="${ctx}/admin/personal/message/${parent.id}/forward?BackURL=<doshou:backURL/>">
                    <i class="icon-file-alt"></i>
                        ${op}
                </a>
            </li>
        ...
        <div class="accordion message">
            ...
            <form:form id="editForm" method="post" commandName="m" cssClass="form-horizontal form-small">
                ...
                <c:if test="${op eq '发送新消息' or op eq '转发消息' or op eq '发送草稿'}">
                    <div class="control-group">
                        ...
                        <div id="search-receiver" class="controls">
                            ...
                            <input type="text" id="receiverId_msg" name="receiver" value="${receiver}"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:input path="title" cssClass="validate[required,minSize[5],maxSize[200]]"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:textarea id="content" path="content.content" data-promptPosition="topRight:-200"
