...
<div data-table="table" class="panel">
    ...
    <a href="<doshou:backURL/>" class="btn btn-link pull-right">返回</a>
    <a href="?backURL=<doshou:backURL/>" class="btn btn-link pull-right">刷新</a>
    ...
    <table class="table table-bordered">
        ...
        <tr class="bold info">
            <td colspan="2">
                ${cacheName} 键列表
                <dsform:input path="searchText" class="input-medium pull-right no-margin" placeholder="回车模糊查询"/>
            </td>
        </tr>
...
$(function() {
    $("#searchText").keyup(function(event) {
        if(event.keyCode == 13) {
            window.location.href = "?searchText=" + this.value + "&backURL=<doshou:backURL/>";
        }
    });
