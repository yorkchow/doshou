...
<div data-table="table" class="panel">
    ...
    <div class="form-inline">
        ...
        <form class="span7">
            ...
            &nbsp;&nbsp;
            <dsform:label path="entityIds">实体编号：</dsform:label>
            <dsform:input path="entityIds" cssClass="input-medium" placeholder="多个之间，逗号分隔"/>
        </form>
        ...
        <form class="span7">
            ...
            &nbsp;&nbsp;
            <dsform:label path="collectionEntityIds">集合所属实体编号：</dsform:label>
            <dsform:input path="collectionEntityIds" cssClass="input-medium" placeholder="多个之间，逗号分隔"/>
        </form>
        <div style="line-height: 70px;">
