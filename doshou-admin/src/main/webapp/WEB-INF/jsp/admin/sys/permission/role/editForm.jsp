...
<ul class="nav nav-tabs">
    <shiro:hasPermission name="sys:role:create">
        <c:if test="${op eq '新增'}">
            <li ${op eq '新增' ? 'class="active"' : ''}>
                <a href="${ctx}/admin/sys/permission/role/create?BackURL=<doshou:BackURL/>">
    ...
    <c:if test="${not empty m.id}">
        <li ${op eq '查看' ? 'class="active"' : ''}>
            <a href="${ctx}/admin/sys/permission/role/${m.id}?BackURL=<doshou:BackURL/>">
        ...
        <shiro:hasPermission name="sys:role:update">
            <li ${op eq '修改' ? 'class="active"' : ''}>
                <a href="${ctx}/admin/sys/permission/role/${m.id}/update?BackURL=<doshou:BackURL/>">
                    <i class="icon-edit"></i>
                    修改
                </a>
            </li>
        ...
        <shiro:hasPermission name="sys:role:delete">
            <li ${op eq '删除' ? 'class="active"' : ''}>
                <a href="${ctx}/admin/sys/permission/role/${m.id}/delete?BackURL=<doshou:BackURL/>">
