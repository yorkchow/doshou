    ...
    <ul class="nav nav-tabs">
        <c:if test="${op eq '新增'}">
            <li ${op eq '新增' ? 'class="active"' : ''}>
                <a href="${ctx}/admin/sys/permission/permission/create?BackURL=<doshou:BackURL/>">
        ...
        <c:if test="${not empty m.id}">
            <li ${op eq '查看' ? 'class="active"' : ''}>
                <a href="${ctx}/admin/sys/permission/permission/${m.id}?BackURL=<doshou:BackURL/>">
                    <i class="icon-eye-open"></i>
                    查看
                </a>
            </li>
            <li ${op eq '修改' ? 'class="active"' : ''}>
                <a href="${ctx}/admin/sys/permission/permission/${m.id}/update?BackURL=<doshou:BackURL/>">
                    <i class="icon-edit"></i>
                    修改
                </a>
            </li>
            <li ${op eq '删除' ? 'class="active"' : ''}>
                <a href="${ctx}/admin/sys/permission/permission/${m.id}/delete?BackURL=<doshou:BackURL/>">
